...
class Handlers {
    constructor(chatContainer, fileContainer) {
        this.chatContainer = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.chat-output');
        this.fileContainer = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#file-container');
    }
    ...
    showRoomURL(roomid, roomPassword) {
        ...
        __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.room-urls').append(html);
        __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.share-url').attr('data-clipboard-text', roomQueryStringURL);
    }

    //Create Overlay on close
    overlayRemote(ctx) {
        const closeSessionOverlay = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.overlay-closed-session');
        let reconnect = `<a href="${window.location}" class="reconnect">Reconnect</a>`;
        __WEBPACK_IMPORTED_MODULE_0_jquery___default()(ctx).find('.closed-session', closeSessionOverlay).append(reconnect);
        __WEBPACK_IMPORTED_MODULE_0_jquery___default()(ctx).find(closeSessionOverlay).fadeIn();
    }
    ...
    addCamControls(ctx, pseudo, event) {
        ...
        let muted = false;
        let camOffed = false;
        const mute = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.mute');
        const camOff = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.cam-off');
        mute.on('click', function () {
            if (!muted) {
                console.log('muted');
                __WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).addClass('muted');
                connection.attachStreams[0].mute('audio');
                muted = true;
            } else {
                console.log('unmuted');
                __WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).removeClass('muted');
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_jquery__ = __webpack_require__(48);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_jquery___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_jquery__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__vendors_clipboard_min__ = __webpack_require__(125);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__vendors_clipboard_min___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__vendors_clipboard_min__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__vendors_RTCMultiConnection_min__ = __webpack_require__(124);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__vendors_RTCMultiConnection_min___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__vendors_RTCMultiConnection_min__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__vendors_FileBufferReader__ = __webpack_require__(123);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__vendors_FileBufferReader___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3__vendors_FileBufferReader__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__vendors_getScreenId__ = __webpack_require__(126);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__vendors_getScreenId___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4__vendors_getScreenId__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_animejs__ = __webpack_require__(88);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_screenfull__ = __webpack_require__(315);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_screenfull___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_6_screenfull__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__reveal__ = __webpack_require__(122);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__modules_Handlers__ = __webpack_require__(49);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__modules_Participants__ = __webpack_require__(121);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__modules_ChatShare__ = __webpack_require__(120);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__modules_CamHandler__ = __webpack_require__(119);
//External libraries
...
let handlers = new __WEBPACK_IMPORTED_MODULE_8__modules_Handlers__["a" /* default */]();
let participants = new __WEBPACK_IMPORTED_MODULE_9__modules_Participants__["a" /* default */]();
let chatShare = new __WEBPACK_IMPORTED_MODULE_10__modules_ChatShare__["a" /* default */]();
let camHandler = new __WEBPACK_IMPORTED_MODULE_11__modules_CamHandler__["a" /* default */]();

//////////////////////////////////////////
__WEBPACK_IMPORTED_MODULE_0_jquery___default()(function () {
    //Open and join Room Buttons
    const openRoom = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#open-room');
    const joinRoom = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#join-room');
    //RoomID and RoomPassword
    const roomPassword = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#room-password');
    const roomId = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#room-id');
    const clientEmail = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#client-email');
    //ShareRoom controls
    const screenShare = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.add-stream');
    const screenShareStop = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.remove-stream');
    const closeSession = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.close-session');
    //Containers
    const body = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('body');
    const mainWrapper = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.content-wrap');
    const closeSessionOverlay = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.overlay-closed-session');
    const argumentary = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.argumentary');
    const toolbar = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.toolbox-bar');
    const roomCtn = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.room-container');
    const fileContainer = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#file-container');
    //Main Form
    const form = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.form-inputs');
    const inputsRoom = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('input.input__field');
    const btnChat = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.btn-chatbox');
    //Toolbox
    const toolbox = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.toolbox');
    const toolBtn = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.tool');
    const share = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.share-file');
    //Chatbox
    const sendMsg = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#send');
    const inputChat = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#input-text-chat');
    ...
    openRoom.click(() => {
        ...
        const copyUrl = new __WEBPACK_IMPORTED_MODULE_1__vendors_clipboard_min___default.a('.url-room', {
            text(trigger) {
                return trigger.getAttribute('data-clipboard-text');
            }

        });
        new __WEBPACK_IMPORTED_MODULE_1__vendors_clipboard_min___default.a('.share-url', {
            text(trigger) {
                return trigger.getAttribute('data-clipboard-text');
            }
        });
        ...
        copyUrl.on('success', e => {
            __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.url-room').html('Copied');
            e.clearSelection();
        });
    ...
    connection.videosContainer = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.video-container');
    var rev = new RevealFx(document.querySelector('.logo'), {
        revealSettings: {
            ...
            onStart: function (contentEl, revealerEl) {
                __WEBPACK_IMPORTED_MODULE_5_animejs___default.a.remove(contentEl);
    ...
    function animeInit() {
        ...
        if (connection.isInitiator) {
            mainWrapper.addClass('initCon');
        } else {
            mainWrapper.addClass('initRemote');
        }
        var animateTools = __WEBPACK_IMPORTED_MODULE_5_animejs___default.a.timeline();
        animateTools.add({
    ...
    connection.onstream = event => {
        ...
        if (document.getElementById(event.streamid)) {
            ...
            __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.participant').each(function () {
                const toRemove = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).data('user');
    ...
    connection.onEntireSessionClosed = event => {
        if (!connection.isInitiator) {
            ...
            __WEBPACK_IMPORTED_MODULE_0_jquery___default()('p', closeSessionOverlay).html(`You have closed the room`);
            let reconnect = `<a href="/" class="reconnect">Create new room</a>`;
            __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.closed-session', closeSessionOverlay).append(reconnect);
    ...
    screenShareStop.click(function () {
        ...
        __WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).removeClass('inactive').addClass('active');
    });
    ...
    __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.close-file').on('click', () => {
        chatShare.closeFile();
    });
    ...
    inputsRoom.focus(function () {
        __WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).parent().toggleClass('input--filled');
    });

    inputsRoom.blur(function () {
        var inputVal = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).val();
        if (!inputVal) {
            __WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).parent().removeClass('input--filled');
        } else {
            __WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).parent().addClass('input--filled');
        }
    });
    ...
    toolBtn.on('click', function () {
        ...
        if (toToggle.hasClass('is-open')) {
            ...
            removeToolbox();
            __WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).addClass('active').removeClass('inactive');
            toToggle.addClass('is-open');
        }
    });

    __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.close-panel').click(() => {
        removeToolbox();
        toolBtn.removeClass('inactive');
        screenShare.removeClass('inactive');
    });
    ...
    if (roomid && roomid.length && password && password.length) {
        ...
        joinRoom.click(() => {
            __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.room-name .r-name').html(roomId.val());
            connection.extra.username = document.getElementById('username').value || 'username';
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_jquery__ = __webpack_require__(48);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_jquery___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_jquery__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__Handlers__ = __webpack_require__(49);


class CamHandler extends __WEBPACK_IMPORTED_MODULE_1__Handlers__["a" /* default */] {
    constructor(chatContainer, fileContainer) {
    ...
    createScreenShare(cam) {
        ...
        cam.removeAttribute('controls');
        __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.screen-share').append(screenshare).hide().fadeIn();
    }
...
/* harmony default export */ __webpack_exports__["a"] = CamHandler;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_jquery___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_jquery__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__Handlers__ = __webpack_require__(49);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_plyr__ = __webpack_require__(312);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_plyr___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_plyr__);



class ChatShare extends __WEBPACK_IMPORTED_MODULE_1__Handlers__["a" /* default */] {
    constructor(chatContainer, fileContainer) {
        super(chatContainer, fileContainer);
        this.argumentary = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.argumentary');
    }
    ...
    sendData(toSend) {
        ...
        const src = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(toSend).data('src');
        connection.send(src);
        this.appendMsg(src);
    }
    ...
    getToBottom(container) {
        const ctxH = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(container).height();
        if (ctxH >= 450) {
            __WEBPACK_IMPORTED_MODULE_0_jquery___default()(container).addClass('scroll-init');
        }
        __WEBPACK_IMPORTED_MODULE_0_jquery___default()(container).stop().animate({
            scrollTop: __WEBPACK_IMPORTED_MODULE_0_jquery___default()(container)[0].scrollHeight
        }, 800);
    }

    returnFile(el) {
        const BASE_URL = '/shared-data.json';
        const emptyArg = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.empty-arg');
        fetch(BASE_URL, { method: 'GET' }).then(res => res.json()).then(data => {
            let dataSrc = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(el).data('src');
            let re = /[^/]+$/;
            ...
            __WEBPACK_IMPORTED_MODULE_0_jquery___default()('h3', this.argumentary).html(results.title);
            __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.txt-argumentary', this.argumentary).html(template);
        });
    }
    ...
    closeFile() {
        ...
        connection.send(src);
        this.appendMsg(src);
        __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.txt-argumentary', this.argumentary).html('nothing to show');
        __WEBPACK_IMPORTED_MODULE_0_jquery___default()('h3', this.argumentary).html('//');
    }
}

/* harmony default export */ __webpack_exports__["a"] = ChatShare;
...
class Participants extends __WEBPACK_IMPORTED_MODULE_1__Handlers__["a" /* default */] {
    constructor(chatContainer, fileContainer) {
        super(chatContainer, fileContainer);
    }
    ...
    getParticipants(event) {
        ...
        __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.participants').append(participantsTpl).hide().fadeIn();
    }
    ...
    removeParticipant(event) {
        ...
        __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.participant').each(function () {
            const toRemove = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).data('user');
            if (username == toRemove) {
                __WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).fadeOut().remove();
            }
        });
        __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.video-username').each(function () {
            const toRemove = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).data('username');
            if (username == toRemove) {
                __WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).parent().fadeOut().remove();
            }
        });
    }
}
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_animejs__ = __webpack_require__(88);
...
(function (window) {
    ...
    RevealFx.prototype.reveal = function (revealSettings) {
        ...
        var revealSettings = revealSettings || this.options.revealSettings;
        var direction = revealSettings.direction || defaults.direction;
        var transformSettings = this._getTransformSettings(direction);

        this.revealer.style.WebkitTransform = this.revealer.style.transform = transformSettings.val;

        this.revealer.style.WebkitTransformOrigin = this.revealer.transformOrigin = transformSettings.origin.initial;
        ...
        var animationSettings = {
            ...
            complete: function () {
                ...
                __WEBPACK_IMPORTED_MODULE_0_animejs___default()(animationSettings_2);
            }
        };
        ...
        __WEBPACK_IMPORTED_MODULE_0_animejs___default()(animationSettings);
    };
...
"use strict";
/* WEBPACK VAR INJECTION */(function(Buffer) {// Last time updated: 2017-02-10 7:54:29 AM UTC
...
(function () {
    ...
    var serialize = function (obj, callback) {
        ...
        unit = Length[type] === undefined || Length[type] === null ? 0 : window[Length[type] + 'Array'].BYTES_PER_ELEMENT;
...
"use strict";
/* WEBPACK VAR INJECTION */(function(global) {var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;// Last time updated: 2017-01-18 3:37:39 AM UTC
...
window.RTCMultiConnection = function (roomid, forceOptions) {
    function SocketConnection(connection, connectCallback) {
        var parameters = "";parameters += "?userid=" + connection.userid, parameters += "&sessionid=" + connection.sessionid, parameters += "&msgEvent=" + connection.socketMessageEvent, parameters += "&socketCustomEvent=" + connection.socketCustomEvent, parameters += "&autoCloseEntireSession=" + !!connection.autoCloseEntireSession, parameters += "&maxParticipantsAllowed=" + connection.maxParticipantsAllowed, connection.enableScalableBroadcast && (parameters += "&enableScalableBroadcast=true", parameters += "&maxRelayLimitPerUser=" + (connection.maxRelayLimitPerUser || 2)), connection.socketCustomParameters && (parameters += connection.socketCustomParameters);try {
        ...
        }connection.socket.isIO = !0;var mPeer = connection.multiPeersHandler;connection.socket.on("extra-data-updated", function (remoteUserId, extra) {
            connection.peers[remoteUserId] && (connection.peers[remoteUserId].extra = extra, connection.onExtraDataUpdated({ userid: remoteUserId, extra: extra }), connection.peersBackup[remoteUserId] || (connection.peersBackup[remoteUserId] = { userid: remoteUserId, extra: {} }), connection.peersBackup[remoteUserId].extra = extra);
            ...
            onUserLeft(userid), connection.onUserStatusChanged({ userid: userid, status: "offline", extra: connection.peers[userid] ? connection.peers[userid].extra || {} : {} });var eventObject = { userid: userid, extra: {} };connection.peersBackup[eventObject.userid] && (eventObject.extra = connection.peersBackup[eventObject.userid].extra), connection.onleave(eventObject);
        });var alreadyConnected = !1;connection.socket.resetProps = function () {
            alreadyConnected = !1;
        ...
        function initFileBufferReader() {
            ...
            skipPeers = ["getAllParticipants", "getLength", "selectFirst", "streams", "send", "forEach"];connection.peersBackup = {}, connection.peers = { getLength: function () {
                ...
                var that = this;if (!isNull(data.size) && !isNull(data.type)) return void self.shareFile(data, remoteUserId);if (!("text" === data.type || data instanceof ArrayBuffer || data instanceof DataView)) return void TextSender.send({ text: data, channel: this, connection: connection, remoteUserId: remoteUserId });if ("text" === data.type && (data = JSON.stringify(data)), remoteUserId) {
            ...
            return userPreferences || (userPreferences = {}), { streamsToShare: userPreferences.streamsToShare || {}, rtcMultiConnection: connection, connectionDescription: userPreferences.connectionDescription, userid: remoteUserId, localPeerSdpConstraints: userPreferences.localPeerSdpConstraints, remotePeerSdpConstraints: userPreferences.remotePeerSdpConstraints, dontGetRemoteStream: !!userPreferences.dontGetRemoteStream, dontAttachLocalStream: !!userPreferences.dontAttachLocalStream, renegotiatingPeer: !!userPreferences.renegotiatingPeer, peerRef: userPreferences.peerRef, channels: userPreferences.channels || [], onLocalSdp: function (localSdp) {
                    ...
                    if (connection.peers[remoteUserId] && connection.peers[remoteUserId].streams.push(stream), isPluginRTC && window.PluginRTC) {
                        var mediaElement = document.createElement("video"),
                            body = connection.videosContainer;return body.insertBefore(mediaElement, body.firstChild), void setTimeout(function () {
            ...
            if (!connection.socket.isIO && (broadcastersList = (broadcastersList || "").split("|-,-|"), broadcastersList.length)) {
                var firstBroadcaster,
                    remainingBroadcasters = [];broadcastersList.forEach(function (list) {
                    list = (list || "").replace(/ /g, ""), list.length && (firstBroadcaster ? remainingBroadcasters.push(list) : firstBroadcaster = list);
                }), firstBroadcaster && (self.onNegotiationNeeded({ newParticipant: newParticipantId, userPreferences: userPreferences || !1 }, firstBroadcaster), remainingBroadcasters.length && setTimeout(function () {
            ...
            if (!connection.enableFileSharing) throw '"connection.enableFileSharing" is false.';initFileBufferReader(), connection.fbr.readAsArrayBuffer(file, function (uuid) {
        ...
        if ("undefined" != typeof CustomEvent) {
            var eventDetail = { arguments: args, __exposedProps__: args },
                event = new CustomEvent(eventName, eventDetail);obj.dispatchEvent(event);
        }
        ...
        return !!isFirefox || !!isChrome && { mandatory: { chromeMediaSource: screen_constraints.mandatory.chromeMediaSource, chromeMediaSourceId: screen_constraints.mandatory.chromeMediaSourceId } };
        ...
        function getLocalStreams() {
        ...
        };var isFirefoxOffered = !isFirefox;config.remoteSdp && config.remoteSdp.remotePeerSdpConstraints && config.remoteSdp.remotePeerSdpConstraints.isFirefoxOffered && (isFirefoxOffered = !0), localStreams.forEach(function (localStream) {
            ...
            var extra = self.extra;connection.peers[self.userid] && (extra = connection.peers[self.userid].extra || extra), peer && config.onPeerStateChanged({ iceConnectionState: peer.iceConnectionState, iceGatheringState: peer.iceGatheringState, signalingState: peer.signalingState, extra: extra, userid: self.userid });
        };var sdpConstraints = { OfferToReceiveAudio: !!localStreams.length, OfferToReceiveVideo: !!localStreams.length };config.localPeerSdpConstraints && (sdpConstraints = config.localPeerSdpConstraints), defaults.sdpConstraints = setSdpConstraints(sdpConstraints);var streamObject,
            remoteStreamAddEvent = "addstream";peer.addEventListener(remoteStreamAddEvent, function (event) {
            if (event) {
                if (event.streams && event.streams.length && !event.stream) {
                    if (!streamObject) return void (streamObject = new MediaStream());if (event.streams.forEach(function (stream) {
                    ...
                    streamObject = null;
                }var streamsToShare = {};config.remoteSdp && config.remoteSdp.streamsToShare ? streamsToShare = config.remoteSdp.streamsToShare : config.streamsToShare && (streamsToShare = config.streamsToShare);var streamToShare = streamsToShare[event.stream.id];streamToShare && (event.stream.isAudio = streamToShare.isAudio, event.stream.isVideo = streamToShare.isVideo, event.stream.isScreen = streamToShare.isScreen), event.stream.streamid = event.stream.id, event.stream.stop || (event.stream.stop = function () {
                    if (isFirefox) {
                        var streamEndedEvent = "ended";"oninactive" in event.stream && (streamEndedEvent = "inactive"), fireEvent(event.stream, streamEndedEvent);
                    }
        ...
        if (!loadedIceFrame) {
            if (!skip) return loadIceFrame(callback, !0);loadedIceFrame = !0;var iframe = document.createElement("iframe");iframe.onload = function () {
        ...
        var urlsParam = "urls";isPluginRTC && (urlsParam = "url");var obj = {};return obj[urlsParam] = stunStr, obj;
    }function getTURNObj(turnStr, username, credential) {
        var urlsParam = "urls";isPluginRTC && (urlsParam = "url");var obj = { username: username, credential: credential };return obj[urlsParam] = turnStr, obj;
    }function getExtenralIceFormatted() {
        var iceServers = [];return window.RMCExternalIceServers.forEach(function (ice) {
        ...
        function streaming(stream, returnBack) {
            setStreamType(options.localMediaConstraints, stream), options.onGettingLocalMedia(stream, returnBack);var streamEndedEvent = "ended";"oninactive" in stream && (streamEndedEvent = "inactive"), stream.addEventListener(streamEndedEvent, function () {
            ...
            if (isPluginRTC && window.PluginRTC) {
                document.createElement("video");return void window.PluginRTC.getUserMedia({ audio: !0, video: !0 }, function (stream) {
        ...
        if ("PermissionDeniedError" == data) {
            if (chromeMediaSource = "PermissionDeniedError", screenCallback) return screenCallback("PermissionDeniedError");throw new Error("PermissionDeniedError: User rejected to share his screen.");
        ...
        if (callback) {
            if (isFirefox) return isFirefoxExtensionAvailable(callback);if (window.IsAndroidChrome) return chromeMediaSource = "screen", void callback(!0);if ("desktop" == chromeMediaSource) return void callback(!0);window.postMessage("are-you-there", "*"), setTimeout(function () {
                callback("screen" == chromeMediaSource ? !1 : !0);
            }, 2e3);
        }
    }function isFirefoxExtensionAvailable(callback) {
        function messageCallback(event) {
            var addonMessage = event.data;addonMessage && "undefined" != typeof addonMessage.isScreenCapturingEnabled && (isFirefoxAddonResponded = !0, callback(addonMessage.isScreenCapturingEnabled === !0 ? !0 : !1), window.removeEventListener("message", messageCallback, !1));
        }if (callback) {
            if (!isFirefox) return isChromeExtensionAvailable(callback);var isFirefoxAddonResponded = !1;window.addEventListener("message", messageCallback, !1), window.postMessage({ checkIfScreenCapturingEnabled: !0, domains: [document.domain] }, "*"), setTimeout(function () {
                isFirefoxAddonResponded || callback(!0);
            }, 2e3);
        }
    }function getSourceId(callback, audioPlusTab) {
        if (!callback) throw '"callback" parameter is mandatory.';return sourceId ? (callback(sourceId), void (sourceId = null)) : (screenCallback = callback, audioPlusTab ? void window.postMessage("audio-plus-tab", "*") : void window.postMessage("get-sourceId", "*"));
    }function getChromeExtensionStatus(extensionid, callback) {
        if (window.IsAndroidChrome) return chromeMediaSource = "screen", void callback("installed-enabled");if (2 != arguments.length && (callback = extensionid, extensionid = window.RMCExtensionID || "ajhifddimkapgcifgcodmmfdlknahffk"), isFirefox) return callback("not-chrome");var image = document.createElement("img");image.src = "chrome-extension://" + extensionid + "/icon.png", image.onload = function () {
        ...
        var firefoxScreenConstraints = { mozMediaSource: "window", mediaSource: "window", width: 29999, height: 8640 };return isFirefox ? callback(null, firefoxScreenConstraints) : (sourceId = null, void isChromeExtensionAvailable(function (isAvailable) {
        ...
        function receive(data, userid, extra) {
            var uuid = data.uuid;if (content[uuid] || (content[uuid] = []), content[uuid].push(data.message), data.last) {
                var message = content[uuid].join("");data.isobject && (message = JSON.parse(message));var receivingTime = new Date().getTime(),
                    latency = receivingTime - data.sendingTime,
                    e = { data: message, userid: userid, extra: extra, latency: latency };connection.autoTranslateText ? (e.original = e.data, connection.Translator.TranslateText(e.data, function (translatedText) {
        ...
        isMobileDevice = !!navigator.userAgent.match(/Android|iPhone|iPad|iPod|BlackBerry|IEMobile/i);"undefined" != typeof cordova && (isMobileDevice = !0, isChrome = !0), navigator && navigator.userAgent && navigator.userAgent.indexOf("Crosswalk") !== -1 && (isMobileDevice = !0, isChrome = !0);var isPluginRTC = !isMobileDevice && (isSafari || isIE);isPluginRTC && "undefined" != typeof URL && (URL.createObjectURL = function () {});var chromeVersion = (!!(window.process && "object" == typeof window.process && window.process.versions && window.process.versions["node-webkit"]), 50),
        matchArray = navigator.userAgent.match(/Chrom(e|ium)\/([0-9]+)\./);isChrome && matchArray && matchArray[2] && (chromeVersion = parseInt(matchArray[2], 10));var firefoxVersion = 50;matchArray = navigator.userAgent.match(/Firefox\/(.*)/), isFirefox && matchArray && matchArray[1] && (firefoxVersion = parseInt(matchArray[1], 10)), window.addEventListener || (window.addEventListener = function (el, eventName, eventHandler) {
        el.attachEvent && el.attachEvent("on" + eventName, eventHandler);
    }), window.attachEventListener = function (video, type, listener, useCapture) {
        video.addEventListener(type, listener, useCapture);
    };var MediaStream = window.MediaStream;"undefined" == typeof MediaStream && "undefined" != typeof webkitMediaStream && (MediaStream = webkitMediaStream), "undefined" != typeof MediaStream && ("getVideoTracks" in MediaStream.prototype || (MediaStream.prototype.getVideoTracks = function () {
        if (!this.getTracks) return [];var tracks = [];return this.getTracks.forEach(function (track) {
        ...
        function getBrowserInfo() {
            var nameOffset,
                ...
                majorVersion = parseInt(navigator.appVersion, 10);if (isOpera) {
            ...
            var isPrivate;if (window.webkitRequestFileSystem) window.webkitRequestFileSystem(window.TEMPORARY, 1, function () {
                isPrivate = !1;
            }, function (e) {
                isPrivate = !0;
            ...
            var unknown = "-",
                ...
                os = unknown,
                clientStrings = [{ s: "Windows 10", r: /(Windows 10.0|Windows NT 10.0)/ }, { s: "Windows 8.1", r: /(Windows 8.1|Windows NT 6.3)/ }, { s: "Windows 8", r: /(Windows 8|Windows NT 6.2)/ }, { s: "Windows 7", r: /(Windows 7|Windows NT 6.1)/ }, { s: "Windows Vista", r: /Windows NT 6.0/ }, { s: "Windows Server 2003", r: /Windows NT 5.2/ }, { s: "Windows XP", r: /(Windows NT 5.1|Windows XP)/ }, { s: "Windows 2000", r: /(Windows NT 5.0|Windows 2000)/ }, { s: "Windows ME", r: /(Win 9x 4.90|Windows ME)/ }, { s: "Windows 98", r: /(Windows 98|Win98)/ }, { s: "Windows 95", r: /(Windows 95|Win95|Windows_95)/ }, { s: "Windows NT 4.0", r: /(Windows NT 4.0|WinNT4.0|WinNT|Windows NT)/ }, { s: "Windows CE", r: /Windows CE/ }, { s: "Windows 3.11", r: /Win16/ }, { s: "Android", r: /Android/ }, { s: "Open BSD", r: /OpenBSD/ }, { s: "Sun OS", r: /SunOS/ }, { s: "Linux", r: /(Linux|X11)/ }, { s: "iOS", r: /(iPhone|iPad|iPod)/ }, { s: "Mac OS X", r: /Mac OS X/ }, { s: "Mac OS", r: /(MacPPC|MacIntel|Mac_PowerPC|Macintosh)/ }, { s: "QNX", r: /QNX/ }, { s: "UNIX", r: /UNIX/ }, { s: "BeOS", r: /BeOS/ }, { s: "OS/2", r: /OS\/2/ }, { s: "Search Bot", r: /(nuhk|Googlebot|Yammybot|Openbot|Slurp|MSNBot|Ask Jeeves\/Teoma|ia_archiver)/ }];for (var id in clientStrings) {
                var cs = clientStrings[id];if (cs.r.test(nAgt)) {
                    os = cs.s;break;
                }
            }var osVersion = unknown;switch (/Windows/.test(os) && (/Windows (.*)/.test(os) && (osVersion = /Windows (.*)/.exec(os)[1]), os = "Windows"), os) {case "Mac OS X":
                    /Mac OS X (10[\.\_\d]+)/.test(nAgt) && (osVersion = /Mac OS X (10[\.\_\d]+)/.exec(nAgt)[1]);break;case "Android":
                    /Android ([\.\_\d]+)/.test(nAgt) && (osVersion = /Android ([\.\_\d]+)/.exec(nAgt)[1]);break;case "iOS":
                    /OS (\d+)_(\d+)_?(\d+)?/.test(nAgt) && (osVersion = /OS (\d+)_(\d+)_?(\d+)?/.exec(nVer), osVersion = osVersion[1] + "." + osVersion[2] + "." + (0 | osVersion[3]));}return { osName: os, osVersion: osVersion };
            ...
            function handleCandidate(candidate) {
                var ipRegex = /([0-9]{1,3}(\.[0-9]{1,3}){3})/,
                    match = ipRegex.exec(candidate);if (!match) return void console.warn("Could not match IP address in", candidate);var ipAddress = match[1];void 0 === ipDuplicates[ipAddress] && callback(ipAddress), ipDuplicates[ipAddress] = !0;
            }var ipDuplicates = {},
                RTCPeerConnection = window.RTCPeerConnection || window.mozRTCPeerConnection || window.webkitRTCPeerConnection,
                useWebKit = !!window.webkitRTCPeerConnection;if (!RTCPeerConnection) {
                var iframe = document.getElementById("iframe");if (!iframe) throw "NOTE: you need to have an iframe in the page right above the script tag.";var win = iframe.contentWindow;RTCPeerConnection = win.RTCPeerConnection || win.mozRTCPeerConnection || win.webkitRTCPeerConnection, useWebKit = !!win.webkitRTCPeerConnection;
            }if (RTCPeerConnection) {
                var servers,
                    mediaConstraints = { optional: [{ RtpDataChannels: !0 }] };useWebKit && (servers = { iceServers: [{ urls: "stun:stun.services.mozilla.com" }] }, "undefined" != typeof DetectRTC && DetectRTC.browser.isFirefox && DetectRTC.browser.version <= 38 && (servers[0] = { url: servers[0].urls }));var pc = new RTCPeerConnection(servers, mediaConstraints);pc.onicecandidate = function (ice) {
            ...
            if (!canEnumerate) return void (callback && callback());if (!navigator.enumerateDevices && window.MediaStreamTrack && window.MediaStreamTrack.getSources && (navigator.enumerateDevices = window.MediaStreamTrack.getSources.bind(window.MediaStreamTrack)), !navigator.enumerateDevices && navigator.enumerateDevices && (navigator.enumerateDevices = navigator.enumerateDevices.bind(navigator)), !navigator.enumerateDevices) return void (callback && callback());MediaDevices = [], audioInputDevices = [], audioOutputDevices = [], videoInputDevices = [];var alreadyUsedDevices = {};navigator.enumerateDevices(function (devices) {
                devices.forEach(function (_device) {
                    var device = {};for (var d in _device) try {
                        "function" != typeof _device[d] && (device[d] = _device[d]);
                    } catch (e) {}alreadyUsedDevices[device.deviceId] || ("audio" === device.kind && (device.kind = "audioinput"), "video" === device.kind && (device.kind = "videoinput"), device.deviceId || (device.deviceId = device.id), device.id || (device.id = device.deviceId), device.label ? ("videoinput" !== device.kind || isWebsiteHasWebcamPermissions || (isWebsiteHasWebcamPermissions = !0), "audioinput" !== device.kind || isWebsiteHasMicrophonePermissions || (isWebsiteHasMicrophonePermissions = !0)) : (device.label = "Please invoke getUserMedia once.", "https:" !== location.protocol && document.domain.search && document.domain.search(/localhost|127.0./g) === -1 && (device.label = "HTTPs is required to get label of this " + device.kind + " device.")), "audioinput" === device.kind && (hasMicrophone = !0, audioInputDevices.indexOf(device) === -1 && audioInputDevices.push(device)), "audiooutput" === device.kind && (hasSpeakers = !0, audioOutputDevices.indexOf(device) === -1 && audioOutputDevices.push(device)), "videoinput" === device.kind && (hasWebcam = !0, videoInputDevices.indexOf(device) === -1 && videoInputDevices.push(device)), MediaDevices.push(device), alreadyUsedDevices[device.deviceId] = device);
            ...
            "undefined" == typeof window && ("undefined" == typeof window && "undefined" != typeof global ? (global.navigator = { userAgent: browserFakeUserAgent, getUserMedia: function () {} }, that.window = global) : "undefined" == typeof window, "undefined" == typeof document && (that.document = {}, document.createElement = document.captureStream = document.mozCaptureStream = function () {
                return {};
            }), "undefined" == typeof location && (that.location = { protocol: "file:", href: "", hash: "" }), "undefined" == typeof screen && (that.screen = { width: 0, height: 0 }));
        }("undefined" != typeof global ? global : window);var navigator = window.navigator;"undefined" != typeof navigator ? ("undefined" != typeof navigator.webkitGetUserMedia && (navigator.getUserMedia = navigator.webkitGetUserMedia), "undefined" != typeof navigator.mozGetUserMedia && (navigator.getUserMedia = navigator.mozGetUserMedia)) : navigator = { getUserMedia: function () {}, userAgent: browserFakeUserAgent };var isMobileDevice = !!/Android|webOS|iPhone|iPad|iPod|BB10|BlackBerry|IEMobile|Opera Mini|Mobile|mobile/i.test(navigator.userAgent || ""),
            ...
            osName = "Unknown OS",
            osVersion = "Unknown OS Version";if (isMobile.any()) osName = isMobile.getOsName();else {
            var osInfo = detectDesktopOS();osName = osInfo.osName, osVersion = osInfo.osVersion;
        }var isCanvasSupportsStreamCapturing = !1,
            isVideoSupportsStreamCapturing = !1;["captureStream", "mozCaptureStream", "webkitCaptureStream"].forEach(function (item) {
            ...
            audioInputDevices = [],
            audioOutputDevices = [],
            videoInputDevices = [];navigator.mediaDevices && navigator.mediaDevices.enumerateDevices && (navigator.enumerateDevices = function (callback) {
            navigator.mediaDevices.enumerateDevices().then(callback)["catch"](function () {
                callback([]);
            });
        });var canEnumerate = !1;"undefined" != typeof MediaStreamTrack && "getSources" in MediaStreamTrack ? canEnumerate = !0 : navigator.mediaDevices && navigator.mediaDevices.enumerateDevices && (canEnumerate = !0);var hasMicrophone = !1,
            hasSpeakers = !1,
            hasWebcam = !1,
            isWebsiteHasMicrophonePermissions = !1,
            isWebsiteHasWebcamPermissions = !1;checkDeviceSupport();var DetectRTC = window.DetectRTC || {};DetectRTC.browser = getBrowserInfo(), detectPrivateMode(function (isPrivateBrowsing) {
            DetectRTC.browser.isPrivateBrowsing = !!isPrivateBrowsing;
        }), DetectRTC.browser["is" + DetectRTC.browser.name] = !0;var isWebRTCSupported = (!!(window.process && "object" == typeof window.process && window.process.versions && window.process.versions["node-webkit"]), !1);["RTCPeerConnection", "webkitRTCPeerConnection", "mozRTCPeerConnection", "RTCIceGatherer"].forEach(function (item) {
            isWebRTCSupported || item in window && (isWebRTCSupported = !0);
        }), DetectRTC.isWebRTCSupported = isWebRTCSupported, DetectRTC.isORTCSupported = "undefined" != typeof RTCIceGatherer;var isScreenCapturingSupported = !1;DetectRTC.browser.isChrome && DetectRTC.browser.version >= 35 ? isScreenCapturingSupported = !0 : DetectRTC.browser.isFirefox && DetectRTC.browser.version >= 34 && (isScreenCapturingSupported = !0), "https:" !== location.protocol && (isScreenCapturingSupported = !1), DetectRTC.isScreenCapturingSupported = isScreenCapturingSupported;var webAudio = { isSupported: !1, isCreateMediaStreamSourceSupported: !1 };["AudioContext", "webkitAudioContext", "mozAudioContext", "msAudioContext"].forEach(function (item) {
            ...
            var width = screen.width ? screen.width : "",
                height = screen.height ? screen.height : "";displayResolution += "" + width + " x " + height;
            ...
            callback = callback || function () {};try {
                var websocket = new WebSocket("wss://echo.websocket.org:443/");websocket.onopen = function () {
        ...
        }, DetectRTC.MediaDevices = MediaDevices, DetectRTC.hasMicrophone = hasMicrophone, DetectRTC.hasSpeakers = hasSpeakers, DetectRTC.hasWebcam = hasWebcam, DetectRTC.isWebsiteHasWebcamPermissions = isWebsiteHasWebcamPermissions, DetectRTC.isWebsiteHasMicrophonePermissions = isWebsiteHasMicrophonePermissions, DetectRTC.audioInputDevices = audioInputDevices, DetectRTC.audioOutputDevices = audioOutputDevices, DetectRTC.videoInputDevices = videoInputDevices;var isSetSinkIdSupported = !1;"setSinkId" in document.createElement("video") && (isSetSinkIdSupported = !0), DetectRTC.isSetSinkIdSupported = isSetSinkIdSupported;var isRTPSenderReplaceTracksSupported = !1;DetectRTC.browser.isFirefox && "undefined" != typeof mozRTCPeerConnection ? "getSenders" in mozRTCPeerConnection.prototype && (isRTPSenderReplaceTracksSupported = !0) : DetectRTC.browser.isChrome && "undefined" != typeof webkitRTCPeerConnection && "getSenders" in webkitRTCPeerConnection.prototype && (isRTPSenderReplaceTracksSupported = !0), DetectRTC.isRTPSenderReplaceTracksSupported = isRTPSenderReplaceTracksSupported;var isRemoteStreamProcessingSupported = !1;DetectRTC.browser.isFirefox && DetectRTC.browser.version > 38 && (isRemoteStreamProcessingSupported = !0), DetectRTC.isRemoteStreamProcessingSupported = isRemoteStreamProcessingSupported;var isApplyConstraintsSupported = !1;"undefined" != typeof MediaStreamTrack && "applyConstraints" in MediaStreamTrack.prototype && (isApplyConstraintsSupported = !0), DetectRTC.isApplyConstraintsSupported = isApplyConstraintsSupported;var isMultiMonitorScreenCapturingSupported = !1;DetectRTC.browser.isFirefox && DetectRTC.browser.version >= 43 && (isMultiMonitorScreenCapturingSupported = !0), DetectRTC.isMultiMonitorScreenCapturingSupported = isMultiMonitorScreenCapturingSupported, DetectRTC.isPromisesSupported = !!("Promise" in window), "undefined" == typeof DetectRTC && (window.DetectRTC = {});var MediaStream = window.MediaStream;"undefined" == typeof MediaStream && "undefined" != typeof webkitMediaStream && (MediaStream = webkitMediaStream), "undefined" != typeof MediaStream ? DetectRTC.MediaStream = Object.keys(MediaStream.prototype) : DetectRTC.MediaStream = !1, "undefined" != typeof MediaStreamTrack ? DetectRTC.MediaStreamTrack = Object.keys(MediaStreamTrack.prototype) : DetectRTC.MediaStreamTrack = !1;var RTCPeerConnection = window.RTCPeerConnection || window.mozRTCPeerConnection || window.webkitRTCPeerConnection;"undefined" != typeof RTCPeerConnection ? DetectRTC.RTCPeerConnection = Object.keys(RTCPeerConnection.prototype) : DetectRTC.RTCPeerConnection = !1, window.DetectRTC = DetectRTC, "undefined" != typeof module && (module.exports = DetectRTC), "function" == "function" && __webpack_require__(316) && !(__WEBPACK_AMD_DEFINE_ARRAY__ = [], __WEBPACK_AMD_DEFINE_RESULT__ = function () {
            return DetectRTC;
        }.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
    }(), document.addEventListener("deviceready", setCordovaAPIs, !1), setCordovaAPIs();var RTCPeerConnection,
        defaults = {};"undefined" != typeof window.RTCPeerConnection ? RTCPeerConnection = window.RTCPeerConnection : "undefined" != typeof mozRTCPeerConnection ? RTCPeerConnection = mozRTCPeerConnection : "undefined" != typeof webkitRTCPeerConnection && (RTCPeerConnection = webkitRTCPeerConnection);
    var RTCSessionDescription = window.RTCSessionDescription || window.mozRTCSessionDescription,
        RTCIceCandidate = window.RTCIceCandidate || window.mozRTCIceCandidate,
        MediaStreamTrack = window.MediaStreamTrack;window.onPluginRTCInitialized = function () {
        ...
        function removeVPX(sdp) {
            ...
            var pattern = new RegExp("a=rtpmap:(\\d+) \\w+\\/\\d+"),
                result = sdpLine.match(pattern);return result && 2 === result.length ? result[1] : null;
        }function setVideoBitrates(sdp, params) {
            if (isMobileDevice) return sdp;params = params || {};var vp8Payload,
                xgoogle_min_bitrate = params.min,
                xgoogle_max_bitrate = params.max,
                sdpLines = sdp.split("\r\n"),
                vp8Index = findLine(sdpLines, "a=rtpmap", "VP8/90000");if (vp8Index && (vp8Payload = getCodecPayloadType(sdpLines[vp8Index])), !vp8Payload) return sdp;var rtxPayload,
                rtxIndex = findLine(sdpLines, "a=rtpmap", "rtx/90000");if (rtxIndex && (rtxPayload = getCodecPayloadType(sdpLines[rtxIndex])), !rtxIndex) return sdp;var rtxFmtpLineIndex = findLine(sdpLines, "a=fmtp:" + rtxPayload.toString());if (null !== rtxFmtpLineIndex) {
            ...
            if (isMobileDevice) return sdp;params = params || {};var opusPayload,
                sdpLines = sdp.split("\r\n"),
        ...
        }var isMobileDevice = !!navigator.userAgent.match(/Android|iPhone|iPad|iPod|BlackBerry|IEMobile/i);return "undefined" != typeof cordova && (isMobileDevice = !0), navigator && navigator.userAgent && navigator.userAgent.indexOf("Crosswalk") !== -1 && (isMobileDevice = !0), { removeVPX: removeVPX, disableNACK: disableNACK, prioritize: prioritize, removeNonG722: removeNonG722, setApplicationSpecificBandwidth: function (sdp, bandwidth, isScreen) {
                return setBAS(sdp, bandwidth, isScreen);
            }, setVideoBitrates: function (sdp, params) {
                return setVideoBitrates(sdp, params);
            }, setOpusAttributes: function (sdp, params) {
                return setOpusAttributes(sdp, params);
            }, preferVP9: preferVP9, forceStereoAudio: forceStereoAudio };
    }();window.BandwidthHandler = CodecsHandler;var loadedIceFrame,
        OnIceCandidateHandler = function () {
        function processCandidates(connection, icePair) {
            var candidate = icePair.candidate,
                iceRestrictions = connection.candidates,
                stun = iceRestrictions.stun,
                turn = iceRestrictions.turn;if (isNull(iceRestrictions.reflexive) || (stun = iceRestrictions.reflexive), isNull(iceRestrictions.relay) || (turn = iceRestrictions.relay), (iceRestrictions.host || !candidate.match(/typ host/g)) && (turn || !candidate.match(/typ relay/g)) && (stun || !candidate.match(/typ srflx/g))) {
        ...
        TextSender = { send: function (config) {
            function sendText(textMessage, text) {
                ...
                textToTransfer = "",
                isobject = !1;isString(initialText) || (isobject = !0, initialText = JSON.stringify(initialText));var uuid = getRandomString(),
                sendingTime = new Date().getTime();sendText(initialText);
        } },
        ...
        function handle(connection) {
            function updateLabel(progress, label) {
                ...
                var helper = progressHelper[file.uuid];if (!helper) return void console.error("No such progress-helper element exists.", file);if (!file.remoteUserId || (helper = progressHelper[file.uuid][file.remoteUserId])) {
        ...
        function handle(connection) {
            connection.autoTranslateText = !1, connection.language = "en", connection.googKey = "AIzaSyCgB5hmFY74WYB-EoWkhr9cAGr6TiTHrEE", connection.Translator = { TranslateText: function (text, callback) {
                    var newScript = document.createElement("script");newScript.type = "text/javascript";var sourceText = encodeURIComponent(text),
                        randomNumber = "method" + connection.token();window[randomNumber] = function (response) {
        ...
        function onUserLeft(remoteUserId) {
            ...
            if (connection.isInitiator && !connection.session.oneway && !connection.session.broadcast && "many-to-many" === connection.direction) {
                var firstBroadcaster = connection.broadcasters[0],
                    otherBroadcasters = [];connection.broadcasters.forEach(function (broadcaster) {
        ...
        }forceOptions = forceOptions || { useDefaultDevices: !0 }, connection.channel = connection.sessionid = (roomid || location.href.replace(/\/|:|#|\?|\$|\^|%|\.|`|~|!|\+|@|\[|\||]|\|*. /g, "").split("\n").join("").split("\r").join("")) + "";var mPeer = new MultiPeers(connection),
            preventDuplicateOnStreamEvents = {};mPeer.onGettingLocalMedia = function (stream) {
            if (!preventDuplicateOnStreamEvents[stream.streamid]) {
                preventDuplicateOnStreamEvents[stream.streamid] = !0;try {
                    stream.type = "local";
            ...
            connectSocket(function () {
                connection.socket.emit(connection.socketMessageEvent, "password" in message ? message : { remoteUserId: message.remoteUserId || remoteUserId, message: message, sender: connection.userid }, callback || function () {});
            });
            ...
            connection.checkPresence(localUserid, function (isRoomExists, roomid) {
                if ("function" == typeof password && (password(isRoomExists, roomid), password = null), isRoomExists) {
                    connection.sessionid = roomid;var localPeerSdpConstraints = !1,
                        remotePeerSdpConstraints = !1,
                        isOneWay = !!connection.session.oneway,
                        isDataOnly = isData(connection.session);remotePeerSdpConstraints = { OfferToReceiveAudio: connection.sdpConstraints.mandatory.OfferToReceiveAudio, OfferToReceiveVideo: connection.sdpConstraints.mandatory.OfferToReceiveVideo }, localPeerSdpConstraints = { OfferToReceiveAudio: isOneWay ? !!connection.session.audio : connection.sdpConstraints.mandatory.OfferToReceiveAudio, OfferToReceiveVideo: isOneWay ? !!connection.session.video || !!connection.session.screen : connection.sdpConstraints.mandatory.OfferToReceiveVideo };var connectionDescription = { remoteUserId: connection.sessionid, message: { newParticipationRequest: !0, isOneWay: isOneWay, isDataOnly: isDataOnly, localPeerSdpConstraints: localPeerSdpConstraints, remotePeerSdpConstraints: remotePeerSdpConstraints }, sender: connection.userid, password: password || !1 };return void beforeJoin(connectionDescription.message, function () {
                        mPeer.onNegotiationNeeded(connectionDescription);
                    });
                }connection.userid;connection.userid = connection.sessionid = localUserid || connection.sessionid, connection.userid += "", connection.socket.emit("changed-uuid", connection.userid), password && connection.socket.emit("set-password", password), connection.isInitiator = !0, isData(connection.session) || connection.captureUserMedia();
            });
        }, connection.open = function (localUserid, isPublicModerator) {
            connection.userid;return connection.userid = connection.sessionid = localUserid || connection.sessionid, connection.userid += "", connection.isInitiator = !0, connectSocket(function () {
            ...
            if (remoteUserId) {
                var eventObject = { userid: remoteUserId, extra: connection.peers[remoteUserId] ? connection.peers[remoteUserId].extra : {} };if (connection.peersBackup[eventObject.userid] && (eventObject.extra = connection.peersBackup[eventObject.userid].extra), connection.onleave(eventObject), connection.peers[remoteUserId]) {
                    ...
                    var newArray = [];connection.broadcasters.forEach(function (broadcaster) {
            ...
            connection.sessionid = !!remoteUserId && (remoteUserId.sessionid || remoteUserId.remoteUserId || remoteUserId) || connection.sessionid, connection.sessionid += "";var localPeerSdpConstraints = !1,
                remotePeerSdpConstraints = !1,
                isOneWay = !1,
                isDataOnly = !1;if (remoteUserId && remoteUserId.session || !remoteUserId || "string" == typeof remoteUserId) {
            ...
            callback = callback || function () {};var session = sessionForced || connection.session;return connection.dontCaptureUserMedia || isData(session) ? void callback() : void ((session.audio || session.video || session.screen) && (session.screen ? connection.getScreenConstraints(function (error, screen_constraints) {
                if (error) throw error;connection.invokeGetUserMedia({ audio: !!isAudioPlusTab(connection) && getAudioScreenConstraints(screen_constraints), video: screen_constraints, isScreen: !0 }, function (stream) {
        ...
        }, connection.extra = {}, connection.attachStreams = [], connection.session = { audio: !0, video: !0 }, connection.enableFileSharing = !1, connection.bandwidth = { screen: 512, audio: 128, video: 512 }, connection.codecs = { audio: "opus",
            video: "VP9" }, connection.processSdp = function (sdp) {
            return isMobileDevice || isFirefox ? sdp : (sdp = CodecsHandler.setApplicationSpecificBandwidth(sdp, connection.bandwidth, !!connection.session.screen), sdp = CodecsHandler.setVideoBitrates(sdp, { min: 8 * connection.bandwidth.video * 1024, max: 8 * connection.bandwidth.video * 1024 }), sdp = CodecsHandler.setOpusAttributes(sdp, { maxaveragebitrate: 8 * connection.bandwidth.audio * 1024, maxplaybackrate: 8 * connection.bandwidth.audio * 1024, stereo: 1, maxptime: 3 }), "VP9" === connection.codecs.video && (sdp = CodecsHandler.preferVP9(sdp)), "H264" === connection.codecs.video && (sdp = CodecsHandler.removeVPX(sdp)), "G722" === connection.codecs.audio && (sdp = CodecsHandler.removeNonG722(sdp)), sdp);
            ...
            var lastAudioDevice, lastVideoDevice;if (DetectRTC.MediaDevices.forEach(function (device) {
                ...
                if (isFirefox) return void (connection.mediaConstraints.audio !== !0 ? connection.mediaConstraints.audio.deviceId = lastAudioDevice.id : connection.mediaConstraints.audio = { deviceId: lastAudioDevice.id });1 == connection.mediaConstraints.audio && (connection.mediaConstraints.audio = { mandatory: {}, optional: [] }), connection.mediaConstraints.audio.optional || (connection.mediaConstraints.audio.optional = []);var optional = [{ sourceId: lastAudioDevice.id }];connection.mediaConstraints.audio.optional = optional.concat(connection.mediaConstraints.audio.optional);
            }if (lastVideoDevice) {
                if (isFirefox) return void (connection.mediaConstraints.video !== !0 ? connection.mediaConstraints.video.deviceId = lastVideoDevice.id : connection.mediaConstraints.video = { deviceId: lastVideoDevice.id });1 == connection.mediaConstraints.video && (connection.mediaConstraints.video = { mandatory: {}, optional: [] }), connection.mediaConstraints.video.optional || (connection.mediaConstraints.video.optional = []);var optional = [{ sourceId: lastVideoDevice.id }];connection.mediaConstraints.video.optional = optional.concat(connection.mediaConstraints.video.optional);
            }
            ...
            var parentNode = connection.videosContainer;parentNode.insertBefore(e.mediaElement, parentNode.firstChild), e.mediaElement.play(), setTimeout(function () {
                e.mediaElement.play();
            }, 5e3);
            ...
            function gumCallback(stream) {
                ...
                return error ? "PermissionDeniedError" === error ? (session.streamCallback && session.streamCallback(null), void (connection.enableLogs && console.error("User rejected to share his screen."))) : alert(error) : void connection.invokeGetUserMedia({ audio: !!isAudioPlusTab(connection) && getAudioScreenConstraints(screen_constraints), video: screen_constraints, isScreen: !0 }, !session.audio && !session.video || isAudioPlusTab(connection) ? gumCallback : connection.invokeGetUserMedia(null, gumCallback));
            ...
            session || (session = connection.session), localMediaConstraints || (localMediaConstraints = connection.mediaConstraints), getUserMediaHandler({ onGettingLocalMedia: function (stream) {
                    var videoConstraints = localMediaConstraints.video;videoConstraints && (videoConstraints.mediaSource || videoConstraints.mozMediaSource ? stream.isScreen = !0 : videoConstraints.mandatory && videoConstraints.mandatory.chromeMediaSource && (stream.isScreen = !0)), stream.isScreen || (stream.isVideo = stream.getVideoTracks().length, stream.isAudio = !stream.isVideo && stream.getAudioTracks().length), mPeer.onGettingLocalMedia(stream), callback && callback(stream);
            ...
            }if (session = session || {}, !RTCPeerConnection.prototype.getSenders) return void connection.addStream(session);if (session instanceof MediaStreamTrack) return void replaceTrack(session, remoteUserId, isVideoTrack);if (session instanceof MediaStream) return session.getVideoTracks().length && replaceTrack(session.getVideoTracks()[0], remoteUserId, !0), void (session.getAudioTracks().length && replaceTrack(session.getAudioTracks()[0], remoteUserId, !1));if (isData(session)) throw "connection.replaceTrack requires audio and/or video and/or screen.";(session.audio || session.video || session.screen) && (session.screen ? connection.getScreenConstraints(function (error, screen_constraints) {
                return error ? alert(error) : void connection.invokeGetUserMedia({ audio: !!isAudioPlusTab(connection) && getAudioScreenConstraints(screen_constraints), video: screen_constraints, isScreen: !0 }, !session.audio && !session.video || isAudioPlusTab(connection) ? gumCallback : connection.invokeGetUserMedia(null, gumCallback));
            }) : (session.audio || session.video) && connection.invokeGetUserMedia(null, gumCallback));
                ...
                stream.alreadySetEndHandler = !0;var streamEndedEvent = "ended";"oninactive" in stream && (streamEndedEvent = "inactive"), stream.addEventListener(streamEndedEvent, function () {
                    if (stream.idInstance && currentUserMediaRequest.remove(stream.idInstance), !isRemote) {
                        ...
                        var peer = connection.peers[streamEvent.userid].peer,
                            streams = [];peer.getRemoteStreams().forEach(function (s) {
                            s.id != stream.id && streams.push(s);
            ...
            mPeer.onNegotiationNeeded({ shiftedModerationControl: !0, broadcasters: existingBroadcasters, firedOnLeave: !!firedOnLeave }, remoteUserId);
            ...
            e && e.mediaElement && ("both" === e.muteType || "video" === e.muteType ? (e.mediaElement.src = null, e.mediaElement.pause(), e.mediaElement.poster = e.snapshot || "https://d30y9cdsu7xlg0.cloudfront.net/png/284742-200.png") : "audio" === e.muteType && (e.mediaElement.muted = !0));
            ...
            return connection.socket ? callback && callback(connection.socket) : connectSocket(callback), connection.socket;
                ...
                if (!options) {
                    var firstStream;for (var str in connection.streamEvents) skipStreams.indexOf(str) !== -1 || firstStream || (firstStream = connection.streamEvents[str]);return firstStream;
                }
            }, selectAll: function () {} }, connection.socketURL = "/", connection.socketMessageEvent = "RTCMultiConnection-Message", connection.socketCustomEvent = "RTCMultiConnection-Custom-Message", connection.DetectRTC = DetectRTC, connection.setCustomSocketEvent = function (customEvent) {
            ...
            if (connection.bandwidth = { audio: 30, video: 30, screen: 30 }, connection.mediaConstraints.audio && connection.mediaConstraints.audio.optional && connection.mediaConstraints.audio.optional.length) {
            ...
            if (!remoteUserId) throw "remoteUserId is required.";return connection.peers[remoteUserId] ? connection.peers[remoteUserId].extra : {};
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(61), __webpack_require__(313)))
